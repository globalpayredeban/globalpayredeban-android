...
import com.redeban.payment.R;
import com.redeban.payment.util.CardUtils;
import com.redeban.payment.util.RedebanTextUtils;
...
import static com.redeban.payment.model.RedebanJsonUtils.optCountryCode;
import static com.redeban.payment.model.RedebanJsonUtils.optCurrency;
import static com.redeban.payment.model.RedebanJsonUtils.optInteger;
import static com.redeban.payment.model.RedebanJsonUtils.optString;
import static com.redeban.payment.model.RedebanJsonUtils.putIntegerIfNotNull;
import static com.redeban.payment.model.RedebanJsonUtils.putStringIfNotNull;

/**
 * A model object representing a Card in the Android SDK.
 */
public class Card extends RedebanJsonModel implements RedebanPaymentSource {
    ...
    public Card(
            ...
            String currency,
            String id) {
        this.number = RedebanTextUtils.nullIfBlank(normalizeCardNumber(number));
        this.expiryMonth = expMonth;
        this.expiryYear = expYear;
        this.cvc = RedebanTextUtils.nullIfBlank(cvc);
        this.holderName = RedebanTextUtils.nullIfBlank(name);
        this.addressLine1 = RedebanTextUtils.nullIfBlank(addressLine1);
        this.addressLine2 = RedebanTextUtils.nullIfBlank(addressLine2);
        this.addressCity = RedebanTextUtils.nullIfBlank(addressCity);
        this.addressState = RedebanTextUtils.nullIfBlank(addressState);
        this.addressZip = RedebanTextUtils.nullIfBlank(addressZip);
        this.addressCountry = RedebanTextUtils.nullIfBlank(addressCountry);
        this.type = asCardBrand(type) == null ? getType() : type;
        this.last4 = RedebanTextUtils.nullIfBlank(last4) == null ? getLast4() : last4;
        this.fingerprint = RedebanTextUtils.nullIfBlank(fingerprint);
        this.funding = asFundingType(funding);
        this.country = RedebanTextUtils.nullIfBlank(country);
        this.currency = RedebanTextUtils.nullIfBlank(currency);
        this.id = RedebanTextUtils.nullIfBlank(id);
    }
    ...
    public boolean validateCVC() {
        if (RedebanTextUtils.isBlank(cvc)) {
            return false;
        }
    ...
    public String getLast4() {
        if (!RedebanTextUtils.isBlank(last4)) {
            return last4;
        }
    ...
    public String getType() {
        if (RedebanTextUtils.isBlank(type) && !RedebanTextUtils.isBlank(number)) {
    ...
    private Card(Builder builder) {
        this.number = RedebanTextUtils.nullIfBlank(normalizeCardNumber(builder.number));
        this.expiryMonth = builder.expMonth;
        this.expiryYear = builder.expYear;
        this.cvc = RedebanTextUtils.nullIfBlank(builder.cvc);
        this.holderName = RedebanTextUtils.nullIfBlank(builder.name);
        this.addressLine1 = RedebanTextUtils.nullIfBlank(builder.addressLine1);
        this.addressLine1Check = RedebanTextUtils.nullIfBlank(builder.addressLine1Check);
        this.addressLine2 = RedebanTextUtils.nullIfBlank(builder.addressLine2);
        this.addressCity = RedebanTextUtils.nullIfBlank(builder.addressCity);
        this.addressState = RedebanTextUtils.nullIfBlank(builder.addressState);
        this.addressZip = RedebanTextUtils.nullIfBlank(builder.addressZip);
        this.addressZipCheck = RedebanTextUtils.nullIfBlank(builder.addressZipCheck);
        this.addressCountry = RedebanTextUtils.nullIfBlank(builder.addressCountry);
        this.last4 = RedebanTextUtils.nullIfBlank(builder.last4) == null
                ? getLast4()
                : builder.last4;
        this.type = asCardBrand(builder.brand) == null
                ? getType()
                : builder.brand;
        this.fingerprint = RedebanTextUtils.nullIfBlank(builder.fingerprint);
        this.funding = asFundingType(builder.funding);
        this.country = RedebanTextUtils.nullIfBlank(builder.country);
        this.currency = RedebanTextUtils.nullIfBlank(builder.currency);
        this.customerId = RedebanTextUtils.nullIfBlank(builder.customer);
        this.cvcCheck = RedebanTextUtils.nullIfBlank(builder.cvcCheck);
        this.id = RedebanTextUtils.nullIfBlank(builder.id);
    }
