package com.redeban.payment.view;
...
import static com.redeban.payment.model.Card.BRAND_RESOURCE_MAP;
import static com.redeban.payment.view.CardInputListener.FocusField.FOCUS_CARD;
import static com.redeban.payment.view.CardInputListener.FocusField.FOCUS_CARDHOLDERNAME;
import static com.redeban.payment.view.CardInputListener.FocusField.FOCUS_CVC;
import static com.redeban.payment.view.CardInputListener.FocusField.FOCUS_EXPIRY;
import static com.redeban.payment.view.CardInputListener.FocusField.FOCUS_POSTAL;
...
public class CardMultilineWidget extends LinearLayout {
    ...
    private RedebanEditText mCvcEditText;
    private RedebanEditText mPostalCodeEditText;
    private RedebanEditText mCardHolderNameEditText;
    ...
    private ImageView imageViewRedebanLogo;
    ...
    private RedebanEditText mFiscalNumberEditText;
    private RedebanEditText mNipEditText;
    ...
    private boolean mShouldShowRedebanLogo;
    ...
    @VisibleForTesting
    CardMultilineWidget(Context context, boolean shouldShowPostalCode, boolean shouldShowCardHolderName, boolean shouldShowScanCard, boolean shouldShowRedebanLogo) {
        super(context);
        ...
        mShouldShowRedebanLogo = shouldShowRedebanLogo;
        initView(null);
    }
    ...
    public void setShouldShowRedebanLogo(boolean shouldShowRedebanLogo) {
        mShouldShowRedebanLogo = shouldShowRedebanLogo;
        adjustViewForRedebanLogoAttribute();
    }
    ...
    void adjustViewForRedebanLogoAttribute() {

        int visibility = mShouldShowRedebanLogo ? View.VISIBLE : View.GONE;
        imageViewRedebanLogo.setVisibility(visibility);
    }
    ...
    private void checkAttributeSet(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                mShouldShowRedebanLogo =
                        a.getBoolean(R.styleable.CardMultilineWidget_shouldShowRedebanLogo, true);
    ...
    private void initView(AttributeSet attrs) {
        ...
        imageViewRedebanLogo = (ImageView) findViewById(R.id.imageViewRedebanLogo);
        ...
        mNipEditText = (RedebanEditText) findViewById(R.id.et_add_source_nip_ml);
        mFiscalNumberEditText = (RedebanEditText) findViewById(R.id.et_add_source_fiscal_number_ml);



        mExpiryDateEditText = (ExpiryDateEditText) findViewById(R.id.et_add_source_expiry_ml);
        mCvcEditText = (RedebanEditText) findViewById(R.id.et_add_source_cvc_ml);
        mPostalCodeEditText = (RedebanEditText) findViewById(R.id.et_add_source_postal_ml);
        mCardHolderNameEditText = (RedebanEditText) findViewById(R.id.et_add_source_cardholdername_ml);
        ...
        mCvcEditText.setAfterTextChangedListener(
                new RedebanEditText.AfterTextChangedListener() {
                    @Override
    ...
    private static class ErrorListener implements RedebanEditText.ErrorMessageListener {
