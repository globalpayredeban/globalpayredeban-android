 ...
 * it will be acting.
 */
class BackUpFieldDeleteListener implements RedebanEditText.DeleteEmptyListener {

    private RedebanEditText backUpTarget;

    BackUpFieldDeleteListener(RedebanEditText backUpTarget) {
