...
/**
 * Utility class for common text-related operations on Redeban data coming from the server.
 */
public class RedebanTextUtils {
    /**
    ...
    static String shaHashInput(@Nullable String toHash) {
        if (RedebanTextUtils.isBlank(toHash)) {
            return null;
        }
